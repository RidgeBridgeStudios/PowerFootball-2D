...
## Corpus Check
- 142 files · ~315,214 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1497 nodes · 1742 edges · 123 communities (92 shown, 22 thin omitted)
...
Cohesion: 0.04
Nodes (48): Claude, Architectural Choke Points, Boot Order projectgodot, CLAUDEmd — Agent Entry Point, Context Budget — Claude Code Sessions, graphify, Process Priority, READ FIRST (+40 more)
...
### Community 16 - "Readme"
Cohesion: 0.06
Nodes (33): Errata History, Errata History Archive, generate_markdown(), get_layer_for_path(), main(), parse_gd_file(), ScriptAPI, AnalyticalSimulationHarness (+25 more)
...
### Community 43 - "fuzz_formations.py"
Cohesion: 0.46
...
### Community 117 - "Data, Persistence & Career Calibration Errata"
Cohesion: 0.40
...
Cohesion: 0.25
Nodes (7): bicycle-kick-dominates-ambiguous-facing, Discovered Rules, dribble-claim-ignores-existing-possessor-dual-driver-jitter, dribble-magnet-forward-overshoot-oscillation, Physics, Ball Dynamics & Kinematics Errata, Table of Contents, verify-external-agent-prompts-against-source-before-executing
...
### Community 124 - "Errata Session History & Handoff Logs"
Cohesion: 0.33
...
## Knowledge Gaps
- **689 isolated node(s):** `python`, `C:\Users\emanu\AppData\Roaming\uv\tools\graphifyy\Scripts\python.exe`, `python`, `C:\Users\emanu\AppData\Roaming\uv\tools\graphifyy\Scripts\python.exe`, `Career Mode (Layer 4) Invariants` (+684 more)
...
- **Why does `Agents` connect `Agents` to `Api Surface`, `Course Implementation Specification`, `Anti Patterns`, `Agents Errata`, `Powerfootball Master Vision`, `mcp_server.py`, `DeterministicMatchSimulator`, `Vector2`, `fuzz_formations.py`, `generate_symbols.py`, `Core Invariants`, `lint_invariants.py`, `Math Solvers`, `benchmark_math.py`, `Readme`, `semantic_search.py`, `Graphify Lifecycle & Agent Navigation Protocol — PowerFootball-2D`, `README.md`?**
