...
**Total Scripts:** 140 | **Public Methods:** 851 | **Signals:** 97 | **Exported Properties:** 494
...
- `enum RequestKind { TRANSFER_BUDGET = 0, WAGE_BUDGET = 1, TRAINING_FACILITIES = 2, YOUTH_FACILITIES = 3, STADIUM_EXPANSION = 4, SCOUTING_NETWORK = 5, NEW_STAFF = 6 }`
...
**Public Methods:**
- `static func make_for( player: PlayerData, p_team_index: int, p_squad_index: int, p_potential: int, today: CareerDate ) -> PlayerCareerState`
